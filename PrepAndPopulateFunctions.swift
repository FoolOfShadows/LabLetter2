...
func clearFields(_ nameArray: [NSTextField]) {
...
func getPatientDemo(_ theText:[String], thePatient: PatientData) -> PatientData {
...
func prepTheCopiedText(_ phrasesToRemove:[String]) -> [String] {
	var results = [""]
...
func extractValues(_ theLabData: [LabData], thePatient: PatientData, wordsToRemove: [String]) {
